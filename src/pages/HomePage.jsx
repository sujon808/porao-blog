            ...
            >
              <div className="relative h-72 lg:h-96 overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 p-8">
                  ...
                  <h2 className="font-serif text-2xl lg:text-3xl font-bold text-white mt-3 mb-2 leading-tight group-hover:text-sky-300 transition-colors">
                    {heroPrimary.title}
                  </h2>
